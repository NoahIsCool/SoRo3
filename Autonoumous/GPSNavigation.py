...
def main():
	...
	#reads all the messages in a loop as they are received
        ...
        while True:
            ...
            vel_North = msg2.n * 1000
            vel_East = msg2.e * 1000

            print "North: ", vel_North, " East: ", vel_East


            # Calculate myHeading using the atan2 function
            myHeading = math.atan2(vel_East, vel_North)
            ...
            print "Bearing: ", math.degrees(theta), ", Distance: ", distance, ",Turn:", math.degrees(deltaTheta), "My Bearing:",math.degrees(myHeading)
