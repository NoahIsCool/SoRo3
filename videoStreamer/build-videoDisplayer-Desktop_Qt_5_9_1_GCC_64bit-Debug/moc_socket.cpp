...
#include "../videoDisplayer/socket.h"
...
QT_MOC_LITERAL(3, 16, 10), // "DataPacket"
QT_MOC_LITERAL(4, 27, 7) // "readUDP"

    },
    "socket\0hasData\0\0DataPacket\0readUDP"
};
...
void socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hasData((*reinterpret_cast< DataPacket(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&socket::hasData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void socket::hasData(DataPacket _t1)
{
